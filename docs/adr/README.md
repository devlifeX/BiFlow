...
| [0087](./0087-windows-powershell-builder.md)                   | Native PowerShell Windows builder                             | Accepted   |
| [0088](./0088-windows-helper-config-retry.md)                  | Retry locked Windows helper config writes                     | Accepted   |
| [0089](./0089-windows-helper-unique-config.md)                 | Use a unique config for locked helper files                   | Accepted   |
| [0090](./0090-skip-identical-locked-windows-payloads.md)       | Skip identical locked Windows payloads                        | Accepted   |
| [0091](./0091-faster-connect-and-visible-failures.md)          | Faster Connect and visible failure reasons                    | Accepted   |
