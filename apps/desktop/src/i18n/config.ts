...
const resources = {
  en: {
    translation: {
      ...
      pinSummary: "{{domains}} domains · {{ips}} IPs",
      binaryMissing: "OpenVPN is not installed on this system.",
      allowDirectWhenDown: "If disconnected, allow direct (leaks real IP)",
      openvpnProfile: "Config file",
      ...
      errors: {
        ...
        platform: "A connection step failed.",
  ...
  fa: {
    translation: {
      ...
      binaryMissing: "OpenVPN روی این سیستم نصب نیست.",
      allowDirectWhenDown: "اگر قطع بود، مستقیم برود (آی‌پی واقعی لو می‌رود)",
      openvpnProfile: "فایل کانفیگ",
      ...
      errors: {
        ...
        platform: "یکی از مراحل اتصال شکست خورد.",
